...
# other dependencies
sudo apt install -y python3-colcon-common-extensions python3-colcon-clean libopencv-dev zenoh-bridge-ros2dds python3-pip python3-catkin-pkg python3-venv mapproxy
