...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/isaac_ros_nitros_april_tag_detection_array_type"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_nitros_april_tag_detection_array_type/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_nitros_april_tag_detection_array_type/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_nitros_april_tag_detection_array_type/environment/path.sh"
