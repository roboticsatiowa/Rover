...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/isaac_ros_managed_nitros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_managed_nitros/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_managed_nitros/environment/path.sh"
