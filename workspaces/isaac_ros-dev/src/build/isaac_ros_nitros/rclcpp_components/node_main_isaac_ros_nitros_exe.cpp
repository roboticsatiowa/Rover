...
#define NODE_MAIN_LOGGER_NAME "isaac_ros_nitros_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libisaac_ros_nitros.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<nvidia::isaac_ros::nitros::NitrosNode>";
