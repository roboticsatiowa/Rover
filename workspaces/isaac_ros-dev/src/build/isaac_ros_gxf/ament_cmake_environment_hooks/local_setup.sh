...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/isaac_ros_gxf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_gxf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_gxf/environment/path.sh"
