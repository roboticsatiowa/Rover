...
class Metaclass_Reset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from isaac_ros_visual_slam_interfaces.srv import _reset
...
class Reset(metaclass=Metaclass_Reset):
    from isaac_ros_visual_slam_interfaces.srv._reset import Reset_Request as Request
    from isaac_ros_visual_slam_interfaces.srv._reset import Reset_Response as Response
