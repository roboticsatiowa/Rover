...
bool isaac_ros_visual_slam_interfaces__srv__get_all_poses__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaac_ros_visual_slam_interfaces.srv._get_all_poses.GetAllPoses_Request", full_classname_dest, 71) == 0);
  }
  isaac_ros_visual_slam_interfaces__srv__GetAllPoses_Request * ros_message = _ros_message;
  {  // max_count
    PyObject * field = PyObject_GetAttrString(_pymsg, "max_count");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->max_count = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of GetAllPoses_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaac_ros_visual_slam_interfaces.srv._get_all_poses");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetAllPoses_Request");
  ...
  {  // max_count
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->max_count);
    {
      int rc = PyObject_SetAttrString(_pymessage, "max_count", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool isaac_ros_visual_slam_interfaces__srv__get_all_poses__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaac_ros_visual_slam_interfaces.srv._get_all_poses.GetAllPoses_Response", full_classname_dest, 72) == 0);
  }
  isaac_ros_visual_slam_interfaces__srv__GetAllPoses_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of GetAllPoses_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaac_ros_visual_slam_interfaces.srv._get_all_poses");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetAllPoses_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
