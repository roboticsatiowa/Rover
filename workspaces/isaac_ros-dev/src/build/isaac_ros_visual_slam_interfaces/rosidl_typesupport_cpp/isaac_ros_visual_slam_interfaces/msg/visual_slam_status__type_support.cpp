...
static const _VisualSlamStatus_type_support_symbol_names_t _VisualSlamStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaac_ros_visual_slam_interfaces, msg, VisualSlamStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isaac_ros_visual_slam_interfaces, msg, VisualSlamStatus)),
  }
};
...
{
  return &::isaac_ros_visual_slam_interfaces::msg::rosidl_typesupport_cpp::VisualSlamStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, isaac_ros_visual_slam_interfaces, msg, VisualSlamStatus)() {
  return get_message_type_support_handle<isaac_ros_visual_slam_interfaces::msg::VisualSlamStatus>();
}
