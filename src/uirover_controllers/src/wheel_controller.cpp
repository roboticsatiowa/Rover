...
{
WheelController::WheelController() : controller_interface::ControllerInterface() {}
...
controller_interface::CallbackReturn WheelController::on_init()
{
  ...
  try
  {
    param_listener_ = std::make_shared<wheel_controller::ParamListener>(get_node());
  }
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&WheelController::reference_callback, this, std::placeholders::_1));
...
void WheelController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
...
controller_interface::return_type WheelController::update(
...
PLUGINLIB_EXPORT_CLASS(
  uirover_controllers::WheelController, controller_interface::ControllerInterface)
