...
#include "test_wheel_controller.hpp"

using uirover_controllers::CMD_MY_ITFS;
using uirover_controllers::control_mode_type;
using uirover_controllers::STATE_MY_ITFS;

class WheelControllerTest : public WheelControllerFixture<TestableWheelController>
{
};

TEST_F(WheelControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(WheelControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(WheelControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(WheelControllerTest, update_success)
{
  SetUpController();
...
TEST_F(WheelControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(WheelControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(WheelControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(WheelControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(WheelControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(WheelControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(WheelControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
