...
#ifndef ROVER_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define ROVER_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // ROVER_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
